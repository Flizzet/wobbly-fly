 ...
 * @version 1.0
 */
public class LevelOneButton extends ButtonComponent {
	...
	public LevelOneButton() {
		this.setImage(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_1_BUTTON, Texture.class));
		this.setImageHovered(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_1_BUTTON, Texture.class));
		this.setImagePushed(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_1_BUTTON_PUSHED, Texture.class));
		
		/* Check if level is locked or unlocked */
		unlocked = Constants.LEVEL_1_UNLOCKED;
	}
