...
/**
 * Button for entering level 2.
 *
 * @author Pedro Dutra (2017)
 * @version 1.0
 */
public class LevelTwoButton extends ButtonComponent {
	...
	public LevelTwoButton() {
		this.setImage(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_2_BUTTON, Texture.class));
		this.setImageHovered(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_2_BUTTON, Texture.class));
		this.setImagePushed(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_2_BUTTON_PUSHED, Texture.class));
		
		/* Check if level is locked or unlocked */
		unlocked = Constants.LEVEL_2_UNLOCKED;
	}
