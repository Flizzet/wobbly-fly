 ...
 * @version 1.0
 */
public class LevelThreeButton extends ButtonComponent {
	
	private boolean unlocked = false;
	private float lockAlpha = .5f;
	
	/** Default instantiable constructor */
	public LevelThreeButton() {
		this.setImage(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_3_BUTTON, Texture.class));
		this.setImageHovered(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_3_BUTTON, Texture.class));
		this.setImagePushed(GameWorld.INSTANCE.assets.get(AssetInfo.LEVEL_CHOICE_MENU_LEVEL_3_BUTTON_PUSHED, Texture.class));
		
		/* Check if level is locked or unlocked */
		unlocked = Constants.LEVEL_3_UNLOCKED;
	}
