...
/**
 * Handles collision for the {@link EnemyHornet}.
 *
 * @author Pedro Dutra (2017)
 * @version 1.0
 */
public class EnemyHornetCollision implements Renderable, Updatable {
	...
	public EnemyHornetCollision(EnemyHornet target) {
		this.target = target;
	}
